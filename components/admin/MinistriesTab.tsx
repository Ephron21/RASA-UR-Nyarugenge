...
import { Briefcase, Plus, Edit, Trash2, Sparkles, Layers, Users, Zap, Flame, Music, Globe, Heart, Shield, Activity, Handshake, Mic } from 'lucide-react';
          ...
          return (
            ...
            >
              <div className="h-48 overflow-hidden relative">
                ...
                <div className="absolute top-6 left-6 w-14 h-14 bg-white/95 backdrop-blur-xl rounded-2xl flex items-center justify-center text-cyan-600 shadow-xl border border-white/20">
                  <Icon size={24} />
                </div>
